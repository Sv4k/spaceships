...
public class FuelTankWithAlienMadeModule extends FuelTank {
    FuelTank fuelTank;

    public FuelTankWithAlienMadeModule(FuelTank fuelTank) {
    ...
    public FuelTank getCopy() {
        return new FuelTankWithAlienMadeModule(fuelTank.getCopy());
    }
    ...
    public String toString() {
        return fuelTank.toString() + "alien made module\n";
    }
}
